...
const FunnyVideo = () => {
    ...
    useEffect(()=>{
        axios.get(`https://metatechvn.store/get/list_video/all_video_wedding_swap`).then(res => {
        ...
        <> 
            ...
            <div className="pb-[70px] pt-[40px]">
                ...
                <div className="mx-auto p-[24px] md:w-[1020px] rounded-xl border bg-white border-gray-100 shadow-xl hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring gap-8">
                  <Link to="/listvideotemplate"><Button variant={'outline'} className="mt-5 ml-[380px] rounded-3xl w-[200px] text-white">Create Now</Button></Link>
                                ...
                                listTemp.slice(0, 100).map((image, index) => {
                                    return (
                                      <div className="" key={index}>
                                        ...
                                        <Link to={`detail/${image.id_user}/${image.id_saved}`}><Button variant={'outline'} className="ml-[80px] mt-3 text-white">See Detail</Button></Link>
                                        </div>                                               
                                    )
                                })
                                }
