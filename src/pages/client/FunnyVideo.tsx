...
const FunnyVideo = () => {
    ...
    return(
        <> 
          ...
          </header><header className="bg-white md:w-[1440px]">
              <div className="mx-auto">
                <div className="flex h-16 items-center justify-between">
                  <div className="flex-1 md:flex md:items-center md:gap-12">
                    <img src="img\logo.png" alt="" />
                                ...
                                listTemp.slice(0, 100).map((image, index) => {
                                    return (
                                      <div className="">
                                        ...
                                        <Link to={`detail/${image.id_user}/${image.id_saved}`}><Button variant={'outline'} className="ml-[80px] mt-3">See Detail</Button></Link>
                                        </div>                                               
                                    )
                                })
                                }
