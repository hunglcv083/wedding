            ...
            <div className="md:pb-[70px] md:pt-[60px] pt-[30px] pb-[30px] md:w-[1440px] w-[390px]">
                <div className="flex md:h-[256px] md:ml-[160px] gap-6 ml-[33px]">
                    ...
                    <div className="hidden md:block">
                         ...
                         <Button variant={"cus3"} className="w-[170px] h-[50px]">
                            Create new
                        ...
                        <Button variant={"cus3"} className="w-[240px] h-[50px] mt-6">
                ...
                <Button variant={"cus3"} className="w-[230px] h-[50px] md:hidden my-4 ml-[80px]">
                            Create new
                            <svg width="21" className="ml-2" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.8118 2.29015L18.5216 10L10.8118 17.7099" stroke="white" strokeWidth="3.08394" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M18.5213 10.0001L2.11914 10.0001" stroke="white" strokeWidth="3.08394" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                <div className="md:ml-[160px] md:w-[1120px] w-[370px] md:mt-11 ml-[10px] md:block hidden">
                    <div className="grid grid-cols-2 gap-6">
                        <div className="md:w-[544px] md:h-[544px] w-[180px] h-[180px] rounded-xl overflow-hidden">
                            <img className="w-full" src="https://picsum.photos/200" alt="" />
                        </div>
                        <div className=" grid grid-cols-2 gap-6">
                            <div className="md:w-[256px] md:h-[256px] w-[180px] h-[180px] rounded-xl overflow-hidden">
                                <img className="w-full" src="https://picsum.photos/200" alt="" />
                            </div>
                            <div className="md:w-[256px] md:h-[256px] w-[180px] h-[180px] rounded-xl overflow-hidden">
                            <img className="w-full" src="https://picsum.photos/200" alt="" />
                    ...
                    <div className="grid grid-cols-3 md:w-[1120px] w-[370px] mt-6 gap-6">
                            <div className="md:w-[352px] md:h-[352px] w-[180px] h-[180px] rounded-xl overflow-hidden">
                            <img className="w-full" src="https://picsum.photos/200" alt="" />
                            </div>
                            <div className="md:w-[352px] md:h-[352px] w-[180px] h-[180px] rounded-xl overflow-hidden">
                            <img className="w-full" src="https://picsum.photos/200" alt="" />
                ...
                <div className="md:ml-[160px] md:w-[1120px] w-[360px] md:mt-11 ml-[15px] items-center justify-center md:hidden">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="md:w-[544px] md:h-[544px] w-[170px] h-[170px] rounded-xl overflow-hidden">
                            <img className="w-full" src="https://picsum.photos/200" alt="" />
                        </div>
                            <div className="md:w-[256px] md:h-[256px] w-[170px] h-[170px] rounded-xl overflow-hidden">
                                <img className="w-full" src="https://picsum.photos/200" alt="" />
                            </div>
                            <div className="md:w-[256px] md:h-[256px] w-[170px] h-[170px] rounded-xl overflow-hidden">
                            <img className="w-full" src="https://picsum.photos/200" alt="" />
                    ...
                    <Button variant={"cus3"} className="md:w-[544px] w-[250px] h-[50px] mt-11 md:ml-[448px] ml-[55px]">
