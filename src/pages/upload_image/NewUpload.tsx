    ...
    return (
        <>
            <div className="bg-[#F2FDFF]">
                <Header />
                <div className="pb-[70px] pt-[40px] md:w-[1440px] w-[390px]">
                    ...
                    <div className="md:flex grid grid-cols-2 gap-6 text-center md:ml-[360px] ml-[45px]">
                        <div className="">
                            {/* image uploader 1 */}
                            ...
                            <Dialog>
                                ...
                                <DialogClose asChild>
                                <Button variant="cus1" className="flex items-center mx-auto mt-6" style={{width:"736px"}}>Save changes</Button>
                                </DialogClose>                            
                            </DialogContent>

                            </Dialog>
                        </div>
                        <svg width="161" className="mt-[60px] md:block hidden" height="141" viewBox="0 0 161 141" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="">
                            ...
                            <div className="flex gap-3">
                                <div
                                    ...
                                    className="md:w-[256px] md:h-[256px] w-[116px] h-[116px] flex text-center items-center justify-center rounded-xl border bg-white border-gray-100 shadow-xl hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
                                >
                                    <input
